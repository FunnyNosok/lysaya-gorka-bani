...
export const banyas: Banya[] = [
  {
    ...
    shortDescription: 'Атмосфера русской избы · гостиная и 2 этаж · парилка, купель, камин, веранда',
    ...
    intro: 'При входе вы попадаете в уютную гостиную с камином. Удобно устроившись в кресле-качалке, можно посмотреть ТВ или включить любимую программу НТВ+. Вы насладитесь по старому русскому обычаю парилкой и окунётесь в купель. Прекрасная комната отдыха на втором этаже создаст особое настроение вашей души.',
    ...
    extraServicesText: 'аренда коттеджа на 20 человек, услуги парильщика (более 10 видов парения), массажист, кафе с русской кухней. Приходите к нам дружной компанией и насладитесь хорошим отдыхом!',

...
export const metadata: Metadata = {
  title: 'Дополнительные услуги — кафе, бассейн, парильщик, массаж | Лысая Горка',
  description: 'Услуги комплекса Русские бани Лысая Горка: кафе с русской кухней, открытый бассейн, услуги парильщика (10+ видов парения), массаж.',
};
    ...
    <>
      <section className="page-hero">
        ...
        <div className="page-hero__inner">
          ...
          <p>Услуги, предоставляемые в оздоровительном комплексе «Русские бани Лысая Горка»: кафе, бассейн, парильщики и массаж.</p>
        </div>
      </section>

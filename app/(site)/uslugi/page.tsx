...
export const metadata: Metadata = {
  ...
  description: 'Услуги бани Лысая горка: кафе русской и кавказской кухни, открытый бассейн, мини-гостиница, услуги парильщика (10+ видов парения), массаж, СПА для девушек.',
};
    ...
    <>
      <section className="page-hero">
        ...
        <div className="page-hero__inner">
          ...
          <p>Услуги, предоставляемые в оздоровительном комплексе русских бань «Лысая горка»: кафе, бассейн, мини-гостиница, парильщики, массаж и СПА-программа для девушек.</p>
        </div>
      </section>

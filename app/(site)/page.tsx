      ...
      <section className="section section--tight">
        <div className="container">
          <div className="features reveal">
            ...
            <div className="feature"><svg className="fi" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M7 14c2-2 4-2 5 0 1-2 3-2 5 0 2-3 0-7-5-7S5 11 7 14Z" /><path d="M12 7v10" /></svg><h3>Веники</h3><p>Берёза, дуб, пихта</p></div>
